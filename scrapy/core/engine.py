...
#signals里面是定义了一系列充当信号的object类实例，和相关引用，没有其他动作。

from scrapy.exceptions import DontCloseSpider
#exceptions里面定义了一些里异常，错误，和警告
#都是直接继承的Exception，Warning或者AssertionError
#没什么特别的操作。

from scrapy.http import Response, Request
#Request是一个从object_ref继承来的类。
#内部包含url，body，encoding，等等属性及操作方法。
#Response也是从object_ref继承的类
#内部也还有与request相同的属性。同时还有相应的request。

from scrapy.core.scraper import Scraper
#-这里面使用了大量的twisted框架，我目前还弄不明白。
